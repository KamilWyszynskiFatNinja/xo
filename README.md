...
$ cp "$GOPATH/src/github.com/KamilWyszynskiFatNinja/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/KamilWyszynskiFatNinja/xo/contrib/oci8.pc /usr/lib/pkgconfig/
